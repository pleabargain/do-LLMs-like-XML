...
import { B as Block, S as Static, f as BlockLabel, K as Code$2, h as Empty, j as IconButton, w as Copy$1, D as Download$1, i as IconButtonWrapper } from './2-D1IjqQPD.js';
...
const lang_map = {
  python: () => import('./index28-cLkCBfm5.js').then((m) => m.python()),
  ...
  markdown: async () => {
    const [md, frontmatter] = await Promise.all([
      import('./index29-CNBlvUY8.js'),
      import('./frontmatter-DjJy0WVX.js')
    ]);
    return md.markdown({ extensions: [frontmatter.frontmatter] });
  },
  json: () => import('./index33-C8X4hC2V.js').then((m) => m.json()),
  html: () => import('./index30-Bb0km_vg.js').then((m) => m.html()),
  css: () => import('./index31-DpJMIZqU.js').then((m) => m.css()),
  javascript: () => import('./index32-ton7EZLP.js').then((m) => m.javascript()),
  jinja2: () => import('./jinja2-BxhAu_54.js').then(
    (m) => StreamLanguage.define(m.jinja2)
  ),
  typescript: () => import('./index32-ton7EZLP.js').then(
...
//# sourceMappingURL=Index13-BcYE_4d4.js.map
